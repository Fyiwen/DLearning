...
def load_data_fashion_mnist(batch_size,i, root='./data'):
    ...
    num_val_samples = num_samples // 10  # 训练集样本分成4份
    ...
    if i==0:
        ...
        val_indices = indices[3*num_val_samples:4*num_val_samples]
        train_indices = indices[:3*num_val_samples]+indices[4*num_val_samples:]
    elif i == 4:
        val_indices = indices[4 * num_val_samples:5 * num_val_samples]
        train_indices = indices[:4 * num_val_samples] + indices[5 * num_val_samples:]
    elif i == 5:
        val_indices = indices[5 * num_val_samples:6 * num_val_samples]
        train_indices = indices[:5 * num_val_samples] + indices[6 * num_val_samples:]
    elif i==6:
        val_indices = indices[6 * num_val_samples:7 * num_val_samples]
        train_indices = indices[:6 * num_val_samples] + indices[7 * num_val_samples:]
    elif i==7:
        val_indices = indices[7 * num_val_samples:8 * num_val_samples]
        train_indices = indices[:7 * num_val_samples] + indices[8 * num_val_samples:]
    elif i==8:
        val_indices = indices[8 * num_val_samples:9 * num_val_samples]
        train_indices = indices[:8 * num_val_samples] + indices[9 * num_val_samples:]
    elif i==9:
        val_indices = indices[9 * num_val_samples:]
        train_indices = indices[:9 * num_val_samples]
