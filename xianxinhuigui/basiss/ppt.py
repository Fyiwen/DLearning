...
'''使用交叉验证增加了验证集，为判断出好的超参，测试集只用来看最后的可视化效果，这个k折交叉验证感觉不太标准，再写一个'''
...
if __name__ == '__main__':
    ...
    l2_lambda=0.01
    train_ch3(net, train_iter, val_iter, cross_entropy, num_epochs, batch_size, [W, b], lr, l2_lambda)
    writer.close()# 激活完pytorch环境下，在命令行tensorboard --logdir=D:\pycode\xianxinhuigui\statistic，然后得到网址http://localhost:6006/去查看图形
    # 预测，最终的所以用测试集
