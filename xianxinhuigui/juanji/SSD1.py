...
# 预测
X = torchvision.io.read_image('D:/pycode/xianxinhuigui/data/img/banana.jpg').unsqueeze(0).float()
...
display(img, output.cpu(), threshold=0.9)  # 筛选所有置信度不低于0.9的边界框
d2l.plt.show()
